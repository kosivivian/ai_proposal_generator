...
export default async function ProposalsPage() {
  ...
  return (
    <div className="space-y-6">
      <RealtimeRefresh tables={["proposals", "proposal_materials", "proposal_sections", "error_log"]} />
      ...
      {proposals.length === 0 ? (
        <div className="rounded-lg border shadow-sm p-12 text-center text-muted-foreground">
